...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="portlet box blue" id="form_wizard_1">
            ...
            <div class="portlet-body form">
						...
						<div id="add_service_step2">
                             ...
                             <div class="row">
                                <div class="col-md-12" style="margin-bottom:15px;"> 
								 ...
								 Rules Entered: <br><br>
							<input class="form-control" readonly type="text" id="rule_list" name="rule_list_val" style="width: 99%; height: 20%; text-transform: Uppercase; color: #0000ff;margin-bottom:20px;"></input>
							
							<div class="infrs" style="background:rgba(160, 159, 159, 0.42);">
									<div class="col-md-4" style="width:230px;background:rgba(160, 159, 159, 0.42);padding:5px; margin-bottom:20px;">
									
									
											
												<select id="Master_cat" class="form-control" data-hide-disabled="true" title="Master Category" data-live-search="true" onchange="master_catagory(this.value)">
				...
				<div class="col-md-4" id="gn" style="width:230px;;background:rgba(160, 159, 159, 0.42);padding:5px;margin-left:20px;margin-bottom:20px; display:none;">
									
									      

									<select id="gen_cat"  class="form-control"  data-hide-disabled="true" title="Genaral Category" data-live-search="true" onchange="open_oparetor()">
			...
			<div class="col-md-4" id="guest"style="width:230px;;padding:5px;margin-left:20px;background:rgba(160, 159, 159, 0.42);margin-bottom:20px;display:none;">
									
	
												<select name="s_guest" id="guest_cat"  class="form-control"   data-hide-disabled="true" title="Guest" data-live-search="true" onchange="open_oparetor()">
	...
	<div class="col-md-4" id="booking" style="width:230px;;background:rgba(160, 159, 159, 0.42);padding:5px;margin-left:20px;margin-bottom:20px;display:none;">
									
									      
												<select name="s_booking" id="booking_cat"  class="form-control"  data-hide-disabled="true" title="Booking" data-live-search="true" onchange="open_oparetor()">
			...
			<div class="col-md-4" id="unit" style="width:230px;;background:rgba(160, 159, 159, 0.42);padding:5px;margin-left:20px;margin-bottom:20px;display:none">
									
		
									
									<select name="s_unit" id="unit_cat"  class="form-control" data-hide-disabled="true" title="Unit" data-live-search="true" onchange="open_oparetor()">
					...
					<div class="col-md-4" id="event" style="width:230px;;background:rgba(160, 159, 159, 0.42);padding:5px;margin-left:20px;margin-bottom:20px;display:none">
									
									      

									
									<select name="s_event" id="event_cat"  class="form-control" data-hide-disabled="true" title="Event" data-live-search="true" onchange="open_oparetor()">
		...
		<div class="col-md-4" id="oparetor"style="width:230px;;background:rgba(160, 159, 159, 0.42);margin-left:20px;margin-bottom:20px;padding:5px;display:none;" >
									

							<select name="s_operator" id="operator_cat"  class="form-control"   data-hide-disabled="true" title="Oparetor" data-live-search="true" onchange= "open_value()">
					...
					<div class="col-md-4" id="value_one" style="width:269px;;background:rgba(160, 159, 159, 0.42); margin-left:20px; margin-bottom:20px; padding-left: 20px; padding-right:20px; padding-top:5px; height: 44px; display:none;" >
							...
							<div class="col-md-4"  id="value_two"style="width:269px;;background:rgba(160, 159, 159, 0.42); margin-left:20px; margin-bottom:20px; padding-left:20px;padding-right:20px;padding-top:5px; display:none;">
							      ...
							      <div class="clearfix"></div>
												...
												<button class="btn blue  pull-right" onclick="append_div();reset_div();" style="margin-right:10px; margin-bottom:10px;">
																		Add Another Rule <i class=""></i>
														</button>
														<div class="clearfix"></div>
                                    <button class="btn blue  pull-right" onclick="append_group()" style="margin-right:10px; margin-bottom:10px;">
                                        Start Grouping <i class=""></i>
                                    </button>
                                    <button id="end_grouping" class="btn blue  pull-right" onclick="append_group2()" style="display:none;margin-right:10px; margin-bottom:10px;">
                                        End Grouping <i class=""></i>
                                    </button>
													...
													<input data-on="AND" data-off="OR" name="andor" id="and_or" type="checkbox"  data-toggle="toggle" onchange="get_and_or()"  data-onstyle="success" data-offstyle="danger">
													</div>-->

                                 
									              <div class="form-group " id="and-or" style="display: none">
														...
														<div class="col-md-4">
															...
															<div class="radio-list">
																<label class="radio-inline">
																	<input type="radio" name="rent_mode_type" id="" value="AND" onclick="concat1(this.value)" >
																	AND</label>
																<label class="radio-inline">
																	<input type="radio" name="rent_mode_type" id="" value="OR" onclick="concat1(this.value)"> OR
																</label>
					...
					<script>
                        ...
                        setInterval(function(){
                            ...
                            if(data.indexOf("(") > -1){
                                ...
                                document.getElementById('end_grouping').style.display="block";
                       ...
                       function append_group(){
                        ...
                        function append_div(){
                            ...
                            document.getElementById('and-or').style.display="block";
