	<?php 
		...
		$due_amount = (($total_amount)+((10*$total_amount)/100)) - $paid_amount;
											...
											<div class="tab-pane active" id="tab1">
	                                                ...
	                                                <table class=""  width="470" style="margin-left:13px;">
                                                        ...
                                                        <tr>
                                                         ...
                                                         <tr>
                                                        	<td>Total Amount:  </td>
                                                            <td style="color:#364150;padding-left:50px;"><i class="fa fa-inr" style="font-size:12px;font-weight:normal;"></i>&nbsp;<?php echo $total_amount; ?></td>
                                                        </tr>
                                                        
                                                        <tr>
                                                        	<td>Tax(%):  </td>
                                                            <td style="color:#364150;padding-left:50px;">10</td>
                                                        </tr>
                                                        
                                                        <tr>
                                                        	<td>Total Amount Payable : </td>
                                                            <td style="color:#364150;padding-left:50px;"><i class="fa fa-inr" style="font-size:12px; font-weight:normal;"></i>&nbsp;<?php echo $total_amount_payable=(($total_amount)+((10*$total_amount)/100)); ?></td>
                                                        </tr>
	                                                        ...
	                                                        <div class="row">
	                                                            <div class="col-md-offset-3 col-md-9">
	                                                                ...
	                                                                Continue <i class="m-icon-swapright m-icon-white"></i>
                                                                       ...
                                                                       <button class="btn red btn-lg ch" type="button" onClick="checkIn()" data-toggle="dropdown"><div style="width:30px;float:left;"><i class="fa fa-bed" style="font-size:16px;"></i></div> Check In</button><br><br>
                                                                       
	                                                                 <button class="btn red btn-lg" type="button"  data-toggle="dropdown">
		...
		<div style="width:30px;float:left;"> 		<i class="fa fa-plus-square" style="font-size:16px;"></i></div>
					Add Transaction 
	                    ...
	                    <ul class="list-unstyled amounts">
								...
								<li>
									<strong>Total Amount Remaining :&nbsp;<b style="color:rgb(227, 91, 90);"><?php echo ($total_amount - $paid_amount  ); ?></b></strong> 
								</li>
						</ul>                               
							...
							Download <i class="fa fa-download"></i>  </a>                                              
	                                        ...
	                                        <!--end of action-->
	                                                        ...
	                                                        <button class="btn red btn-lg frth" id="checkout" onClick="return checkOut(<?php echo $total_amount; ?>,<?php echo $paid_amount; ?>);" type="button" data-toggle="dropdown">
