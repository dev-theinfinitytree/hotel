...
<div class="page-lock">
	<div class="page-logo">
		...
		<img src="<?php echo base_url();?>assets/dashboard/assets/admin/layout/img/logo-big.png" alt="logo"/>
		</a>
	</div>
	<div class="page-body">
		<img class="page-lock-img" src="<?php echo base_url();?>assets/dashboard/assets/admin/pages/media/profile/profile.jpg" alt="">
