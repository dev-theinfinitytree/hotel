    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-edit"></i>List of All Events
                </div>
                <div class="tools">
                    ...
                    <?php if(isset($events) && $events):
                        ...
                        foreach($events as $event):
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo $event->e_from ?>
                                </td>                                
                                <td>
                                    <?php echo $event->e_upto ?>
                                </td>
                                <td bgcolor="<?php echo $event->event_color ?>">
                                ...
                                <td >
                                    ...
                                    <a href="<?php echo base_url() ?>dashboard/delete_event?e_id=<?php echo $event->e_id;?>" class="btn btn-danger pull-right" data-toggle="modal">Delete</a>
                                    <a href="<?php echo base_url();?>dashboard/edit_event?e_id=<?php echo $event->e_id; ?>" class="btn blue pull-right" data-toggle="modal">Edit</a>
                                </td>
                            </tr>
