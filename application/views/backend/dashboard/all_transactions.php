    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-file-archive-o"></i>List of All Transactions
                </div>
                <div class="tools">
                    ...
                    <?php if(isset($transactions) && $transactions):
                        ...
                        foreach($transactions as $transaction):
                            ...
                            <tr >
                                ...
                                <td><?php echo $transaction->hotel_transaction_type_name; ?></td>
                                <td><?php echo $transaction->hotel_transaction_type_description ?></td>
