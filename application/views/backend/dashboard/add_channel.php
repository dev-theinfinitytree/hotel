				...
				<div class="portlet light bordered">
						<div class="portlet-title">
							<div class="caption font-green">
								...
								<span class="caption-subject bold uppercase"> Add Channel</span>
							</div>
						</div>
                    <?php
						...
						<div class="portlet-body form">
								...
								<div class="row">
									...
									<div class="form-group form-md-line-input form-md-floating-label col-md-4">
										<input type="text" autocomplete="off" class="form-control" id="ct_name" name="channel_name"  onkeypress="return onlyLtrs(event, this);">
										<label>	Channel Name<span class="required" id="b_contact_name">*</span></label>
										<span class="help-block">Channel Name...</span>
									</div>
									
									<div class="form-group form-md-line-input form-md-floating-label col-md-4">
										<input type="text" autocomplete="off" class="form-control" id="ct_name" name="channel_contact_name"  onkeypress="return onlyLtrs(event, this);">
										<label>	Contact Name<span class="required" id="b_contact_name">*</span></label>
										<span class="help-block">Contact Name...</span>
									</div>
									<div class="form-group form-md-line-input form-md-floating-label col-md-4">
									
										<input type="text"  autocomplete="off" class="form-control" id="form_control_1" name="channel_address" required="required" >
										<label>Address <span class="required">*</span></label>
										<span class="help-block">Enter Full Address...</span>
									</div>
									<div class="form-group form-md-line-input form-md-floating-label col-md-4">
									
										<input type="text"  autocomplete="off" class="form-control" id="form_control_1" name="channel_contact" required="required" onkeypress="return onlyNos(event, this);" maxlength="10" >
										<label>Mobile No. <span class="required">*</span></label>
										<span class="help-block">Enter Mobile No...</span>
									</div>
									<div class="form-group form-md-line-input form-md-floating-label col-md-4">
										<input  type="email" autocomplete="off" class="form-control" id="form_control_1" name="channel_email" >
										<label>Email </label>
										<span class="help-block">Enter Email Adress...</span>
									</div>
									
									<div class="form-group form-md-line-input form-md-floating-label col-md-3">
										<input type="text" autocomplete="off" class="form-control" id="form_control_1" name="channel_website">
										<label>Website </label>
										<span class="help-block">Enter Website...</span>
									</div>
									<div class="form-group form-md-line-input form-md-floating-label col-md-3">
									
										<input type="text" autocomplete="off" class="form-control" id="form_control_1" name="channel_pan" required="required">
									...
									<div class="form-group form-md-line-input form-md-floating-label col-md-3">
										...
										<input type="text" autocomplete="off" class="form-control" id="form_control_1" name="channel_bank_acc_no" required="required" onkeypress="return onlyNos(event, this);">
									...
									<div class="form-group form-md-line-input form-md-floating-label col-md-3">
										...
										<input type="text"  autocomplete="off" class="form-control" id="form_control_1" name="channel_bank_ifsc" required="required">
                                    ...
                                    <div class="form-group form-md-line-input form-md-floating-label col-md-3">
										...
										<input type="text"  autocomplete="off" class="form-control" id="form_control_1" name="channel_commission" required="required">
