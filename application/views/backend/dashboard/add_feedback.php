           ...
           data-symbol="&#xf005;" data-glyphicon="false" data-rating-class="rating-fa" name="w12" value=""> </label>
                        ...
                        <div class="form-group form-md-line-input form-md-floating-label col-md-12 ">
							<label>Comment </label>
								...
								<textarea autocomplete="off" row="3" type="text" class="form-control" id="form_control_1" name="comment" placeholder="Enter Comment..."></textarea>
                    ...
                    <div class="form-actions noborder" style="margin-top:20px;">
                        <button type="submit" class="btn blue pull-right" style="margin-right:30px;" >Submit</button> <!-- 18.11.2015  -- onclick="return check_mobile();" -->
                        <button  type="reset" class="btn default pull-right" style="margin-right:10px;">Reset</button>
                    </div>
                </div>
                <?php form_close(); ?>
                <!-- END CONTENT -->
