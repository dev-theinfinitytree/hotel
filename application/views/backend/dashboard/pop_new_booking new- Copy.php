                                  ...
                                  <div class="frm2" id="tab2">
											<form action="" class="form-horizontal" id="form2nd" method="POST">	
												...
												<div class="form-group">
													...
													</label> <label style="font-weight:normal;"><?php echo $room_rent; ?></label>
													<div class="col-md-4">
											...
											<div class="form-group">
												...
												<div class="form-group">
													...
													* </span>
													...
													<div class="col-md-4">
				<input type="text" required onkeypress="return onlyNos(event, this);"  class="form-control" name="t_amount" 
