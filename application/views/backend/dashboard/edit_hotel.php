				...
				<div class="col-md-12">
					<div class="portlet box blue" id="form_wizard_1">
						<div class="portlet-title">
							<div class="caption">
								<i class="icon-pin font-green"></i> Edit HOTELS - <span class="step-title">
								Step 1 of 4 </span>
							</div>

						</div>
						<div class="portlet-body form">
							<form action="<?php echo base_url();?>dashboard/edit_hotel" class="form-horizontal"  enctype="multipart/form-data" id="submit_form" method="POST">
												...
												<h3 class="block">Tax Details</h3>
														...
														<label class="control-label col-md-2">Tax Applied?</label>
															<div class="col-md-4">
																<select id="tax" onchange="return hideShow();" name="hotel_tax_applied">
																	<option value="<?php echo $h_edit->	hotel_tax_applied; ?>"><?php echo $h_edit->hotel_tax_applied; ?></option>
						                                            <?php 
																	if($h_edit->hotel_tax_applied =='Yes')
																	{
																	?>
						                                            <option value="No">No</option>
						                                            <?php }
																	else if($h_edit->hotel_tax_applied =='No'){?>
																	<option value="Yes">Yes</option>
						                                            <?php } else{?>
						                                            <option value="Yes">Yes</option>
                                                                    <option value="No">No</option>
                                                    ...
                                                    <div class="form-group" id="service_tax">
														<label class="control-label col-md-2">Service Tax %</label>
															<div class="col-md-4">
																<input type="text" value="<?php echo $h_edit->hotel_service_tax; ?>" class="form-control" name="hotel_service_tax" />
                                                    ...
                                                    <div class="form-group" id="service_tax1">
														<label class="control-label col-md-2">Luxury Tax %</label>
															<div class="col-md-4">
																<input type="text" value="<?php echo $h_edit->hotel_luxury_tax; ?>" class="form-control" name="hotel_luxury_tax" />
                                                     ...
                                                     <div class="form-group" id="service_tax2">
														<label class="control-label col-md-2">Service Charge %</label>
															<div class="col-md-4">
																<input type="text" value="<?php echo $h_edit->hotel_service_charge; ?>" class="form-control" name="hotel_service_charge" />
                                                     ...
                                                     <div class="form-group" id="service_tax3">
														<label class="control-label col-md-2">Standard TAX %</label>
															<div class="col-md-4">
																<input type="text" value="<?php echo $h_edit->hotel_stander_tac; ?>" class="form-control" name="hotel_stander_tac" />
																<span class="help-block">Enter Standard TAX %... </span>
															</div>
												...
												<h3 class="block">Billing Settings</h3>
                                                 	...
                                                 	<div class="form-group">
														<label class="control-label col-md-2">Name On Invoice<span class="required">* </span></label>
															<div class="col-md-4">
																<input type="text" class="form-control" value="<?php echo $h_edit->billing_name; ?>" name="billing_name" required placeholder="Enter Name On Invoice..." />
							...
							<input type="text" class="form-control"  name="billing_country" value="<?php echo $h_edit->billing_country; ?>" id="billing_country" required placeholder="Country" />
								...
								<input type="text" class="form-control" name="billing_ifsc_code" value="<?php echo $h_edit->billing_ifsc_code; ?>" placeholder="Enter IFSC Coad ..." />
											...
											<label class="control-label col-md-5">Default Check In Time</label>
												<div class="col-md-2">
													<input type="text" class="form-control" value="<?php echo $h_edit->hotel_check_in_time_hr; ?>" name="hotel_check_in_time_hr" placeholder="HH" />
																
												</div>
                                                            
                                                       <div class="col-md-2">
													<input type="text" class="form-control" value="<?php echo $h_edit->hotel_check_in_time_mm; ?>" name="hotel_check_in_time_mm"  placeholder="MM"/>
																
															</div>
                                                            
                                                             <div class="col-md-3">
																<select class="form-control" name="hotel_check_in_time_fr">
																	<option value="<?php echo $h_edit->hotel_check_in_time_fr; ?>"><?php echo $h_edit->hotel_check_in_time_fr; ?></option>
						                                            <?php 
                                                 ...
                                                 <div class="form-group col-md-6">       
                                                        <label class="control-label col-md-5">Default Check Out Time</label>
															<div class="col-md-2">
																<input type="text" class="form-control" name="hotel_check_out_time_hr" value="<?php echo $h_edit->hotel_check_out_time_hr; ?>" placeholder="HH" />
																
															</div>
                                                            
                                                            <div class="col-md-2">
																<input type="text" class="form-control" value="<?php echo $h_edit->hotel_check_out_time_mm; ?>" name="hotel_check_out_time_mm"  placeholder="MM"/>
