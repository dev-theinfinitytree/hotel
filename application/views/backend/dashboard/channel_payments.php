    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-edit"></i>Channel Payment
                </div>
                <div class="tools">
                    ...
                    <?php if(isset($channel) && $channel):
                        ...
                        foreach($channel as $brk):
                            ...
                            <tr>
                                ...
                                <td class="again">
                                    <img  width="80px" height="80px"   src="<?php echo base_url();?>upload/channel/<?php if( $brk->channel_photo_thumb == '') { echo "business-man-hi.png"; } else { echo $brk->channel_photo_thumb; }?>" alt=""/>
                                    <?php //echo $brk->b_photo ?>
                                </td>
                                <td>

                                    <?php echo $brk->channel_name ?>                                    
                                </td>
                                <td>
                                    <?php echo $brk->channel_contact_name ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    <?php echo $brk->channel_commission_payed; ?>
                                </td>
                                <!--<td>
                                        <?php //echo $brk->b_email ?>
                                    </td>-->
                                <td>
                                    <?php echo ( $brk->channel_commission_total - $brk->channel_commission_payed); ?>
                                </td>
                                <td>
                                ...
                                <td width="100%">
                                    ...
                                    <button class="btn btn-danger pull-right sd" data-toggle="modal" href="#Make_Payment" onclick="return give_broker_id(<?php echo $brk->channel_id ?>, <?php echo $brk->channel_commission_payed; ?>, <?php echo $brk->channel_commission_total; ?>,<?php echo $brk->channel_commission; ?>)">Make Payment</button>
							...
							<div id="Make_Payment" class="modal fade" tabindex="-1" aria-hidden="true">
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											<div class="scroller" style="height:400px" data-always-visible="1" data-rail-visible1="1">
												...
												<br><br><br>
												<div class="form-group" >
														<label class="control-label col-md-12">Last Payment Made To The Channel<span class="required">*</span></label>
														<div class="col-md-12">
                                ...
                                <?php form_close(); ?>
                                    ...
                                    <button class="btn blue pull-left up"  type="button" data-toggle="modal" href="#Add_Booking" onclick="return give_broker_commission('<?php echo $brk->channel_id ?>','<?php echo $brk->channel_commission ?>');">Add Booking</button>
