...
<div class="invoice" style="width:100%; margin: 0 auto; margin-top:20px;">
				<div class="row invoice-logo">
					<div class="col-xs-6 invoice-logo-space">
						<img src="assets/dashboard/assets/admin/layout/img/logo-hotel.png" alt="logo" class="logo-default" 
				...
				<div class="row">
					...
					<div class="col-xs-4 invoice-payment">
						...
						<ul class="list-unstyled">
							...
							<li>
								<strong>CheckIn Date:</strong> <?php echo $row2->cust_from_date ?> <!--FoodMaster Ltd-->
							</li>
							<li>
								<strong>Checkout Date:</strong> <?php echo $row2->cust_end_date ?><!-- 45454DEMO545DEMO-->
							</li>
							<li>
				...
				<div class="row">
					<div class="col-xs-4">
						<div class="well">
							...
							<address>
							<strong>Admin DocHotel</strong><br/>
							<a href="mailto:#">
					...
					<div class="col-xs-8 invoice-block">
						<ul class="list-unstyled amounts">
							<li>
								<strong>Grand - Total amount:</strong> <?php echo $sum; ?>
							</li>
							<!--<li>
