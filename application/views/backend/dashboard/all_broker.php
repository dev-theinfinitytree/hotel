    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-edit"></i>List of All Broker's
                </div>
                <div class="tools">
                            ...
                            foreach($broker as $brk):
                                ...
                                <tr>
                                   <!-- <td width="50">
									...
									<td>
                                    	  <img  width="60px" height="60px"   src="<?php echo base_url();?>upload/broker/<?php if( $brk->b_photo_thumb == '') { echo "business-man-hi.png"; } else { echo $brk->b_photo_thumb; }?>" alt=""/>
                                    ...
                                    <td>
                                        <?php echo $brk->b_agency_name ?>
                                    </td>
                                    <td>
                                        <?php echo $brk->b_name ?>
                                    </td>
                                    <td>
                                        <?php echo $brk->b_address ?>
                                    </td>
                                    <td>
                                        <?php echo $brk->b_contact ?>
                                    </td>
                                    <!--<td>
                                        <?php //echo $brk->b_email ?>
                                    </td>-->
                                    <td>
                                        <?php echo $brk->b_website ?>
                                    </td>
									<td>
                                        <?php echo $brk->broker_commission ,"%"; ?>
                                    </td>
                                    <!--<td>
                                        <?php //echo $brk->b_pan ?>
                                    </td>
                                    ...
                                    <td width="100%">
                                        ...
                                        <a href="<?php echo base_url() ?>dashboard/delete_broker?b_id=<?php echo $brk->b_id;?>" class="btn btn-danger pull-right" data-toggle="modal">Delete</a>                             
                                        <a href="<?php echo base_url();?>dashboard/edit_broker?b_id=<?php echo $brk->b_id; ?>" class="btn blue pull-right" data-toggle="modal">Edit</a>
                                    </td>
                                </tr>
