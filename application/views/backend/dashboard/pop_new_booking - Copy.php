    ...
    <div class="modal-body col-md-6 ">
        ...
        <div class="frm2" id="tab2">
            <form action="" class="form-horizontal" id="form2nd" method="POST">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">Base Room Rent:
                    </label> <label style="font-weight:normal;">Rs. <?php echo $room_rent; ?></label>
                    <div class="col-md-4">
                        <input type="hidden" class="form-control" name="base_room_rent"  value="<?php echo $room_rent; ?>"/>
                    </div>
                </div>
        ...
        <div class="frm4" id="tab4">
            ...
            <form action="" class="form-horizontal" id="form4th" method="POST">
                 ...
                 <div class="form-group">
<label class="control-label col-md-3">Total Rent:   <label style="font-weight:normal" >500</label>  </label>
<label class="control-label col-md-4">Tax(%):    <label style="font-weight:normal">10%</label>  </label>
<label class="control-label col-md-4">Sum Total: <label style="font-weight:normal">600</label>   </label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" required onkeypress="return onlyNos(event, this);"  class="form-control hlf" name="t_amount"
        ...
        jQuery.ajax(
            {
                ...
                success:function(data)
                {
                    ...
                    $.each(data, function(key,value){
                        ...
                        resultHtml += '<div class="side" style="width:100%;"><div class="col-xs-6 ex"><p><label>Name:</label><label>' + value.g_name + '</label><label>';

                        resultHtml+='<input type="hidden" id="g_id_hide"  value="'+value.g_id+'" ></input>';
                        resultHtml+='<label>Room No:</label><label>102</label><br><label>Last Check In Date:</label><label>01-02-2015</label><br> <button class="act active" name="g_id" id="g_id"" value="'+value.g_id+'" onclick="get_guest('+value.g_id+')" >Continue</button> </p></div>';
                        if(value.g_photo_thumb!='') {
                            resultHtml += '<div class="col-xs-6 sm"><div class="pic pull-right" style="width:100px; height:92px; border:1px solid red;margin-top:11px;">' +
