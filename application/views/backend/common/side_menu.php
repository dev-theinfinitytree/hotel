			...
			<ul class="page-sidebar-menu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
               ...
               <!--
                ...
                <li <?php if(isset($heading) && $heading=='Room'):?> class="start active open" <?php endif;?>>
                    ...
                    <?php if(isset($active) && ($active=='add_room' || $active=='all_rooms' || $active=='unit_type')):?>
					<span class="selected"></span>
                    <?php endif;?>
					<span class="arrow <?php if(isset($active) && ($active=='add_room' || $active=='all_rooms' || $active=='unit_type')) echo 'open';?>"></span>
					</a>
					<ul class="sub-menu">
                        ...
                        <li <?php if(isset($active) && $active=='unit_type') echo "class='active'";?>>
					...
					<ul class="sub-menu">
						  <?php if($this->session->userdata('broker') =='1'):  ?>
							...
							<?php endif; ?>
								...
								<li <?php if(isset($heading) && $heading=='Channel'):?> class="start active open" <?php endif;?>>
									<a href="javascript:;">
										<i class="fa fa-user-plus"></i>
										<span class="title">Channel</span>
										<?php if(isset($active) && ($active=='add_channel' || $active=='all_channel')):?>
											<span class="selected"></span>
										<?php endif;?>
										<span class="arrow <?php if(isset($active) && ($active=='add_channel' || $active=='all_channel')) echo 'open';?>"></span>
									</a>
									<ul class="sub-menu">
										<li <?php if(isset($active) && $active=='add_channel') echo "class='active'";?>>
											<a href="<?php echo base_url();?>dashboard/add_channel">
												<i class="fa fa-pencil"></i>
												Add Channel</a>
										</li>
										<li <?php if(isset($active) && $active=='all_channel') echo "class='active'";?>>
											<a href="<?php echo base_url();?>dashboard/all_channel">
												<i class="fa fa-file-archive-o"></i>
											   View Channel</a>
										</li>
										<li <?php if(isset($active) && $active=='channel_payments') echo "class='active'";?>>
											<a href="<?php echo base_url();?>dashboard/channel_payments">
												<i class="fa fa-file-archive-o"></i>
											   Channel Payments</a>
										</li>
									</ul>
				...
				<!--comment kora suru chanel and broker-->
              ...
              <!--  <?php if($this->session->userdata('broker') =='1'):  ?>
				...
				<!--comment kora sesh chanel and broker-->
                    ...
                    <?php if($this->session->userdata('event') =='1'):  ?>
                        ...
                        <li <?php if(isset($heading) && $heading=='Events'):?> class="start active open" <?php endif;?>>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li <?php if(isset($active) && $active=='add_event') echo "class='active'";?>>
                                    <a href="<?php echo base_url();?>dashboard/add_event">
                                        <i class="fa fa-file-archive-o"></i>
                                        Add an Event</a>
                                </li>
                                <li <?php if(isset($active) && $active=='all_events') echo "class='active'";?>>
                    ...
                    <li <?php if(isset($heading) && $heading=='Reports'):?> class="start active open" <?php endif;?>>
                        <a href="javascript:;">
                            ...
                            <?php if(isset($active) && ($active=='all_reports' || $active=='all_f_reports')):?>
                                <span class="selected"></span>
                            <?php endif;?>
                            <span class="arrow <?php if(isset($active) && ($active=='all_reports' || $active=='all_f_reports')) echo 'open';?>"></span>
                        </a>
                        <ul class="sub-menu">
							...
							<li <?php if(isset($active) && $active=='all_f_reports') echo "class='active'";?>>
                    ...
                    <?php if($this->session->userdata('service') =='1'):  ?>
                        ...
                        <li <?php if(isset($heading) && $heading=='Service'):?> class="start active open" <?php endif;?>>
                            <a href="javascript:;">
                                ...
                                <?php if(isset($active) && ($active=='add_service' || $active=='all_service')):?>
                                    <span class="selected"></span>
                                <?php endif;?>
                                <span class="arrow <?php if(isset($active) && ($active=='add_service' || $active=='all_service')) echo 'open';?>"></span>
                            </a>
                            <ul class="sub-menu">

                                <li <?php if(isset($active) && $active=='add_service') echo "class='active'";?>>
                                    <a href="<?php echo base_url();?>dashboard/add_service">
                                        <i class="fa fa-file-archive-o"></i>
                                        Add Service</a>
                                </li>
                                <li <?php if(isset($active) && $active=='all_service') echo "class='active'";?>>
                                    <a href="<?php echo base_url();?>dashboard/all_service">
                                        <i class="fa fa-file-archive-o"></i>
                                        All Services</a>
                                </li>
                            </ul>
                    ...
                    <?php endif; ?>
                        ...
                        <li <?php if(isset($heading) && $heading=='Assets'):?> class="start active open" <?php endif;?>>
                            <a href="javascript:;">                                
                                ...
                                <?php if(isset($active) && ($active=='add_asset' || $active=='all_assets' || $active=='asset_type')):?>
                                    <span class="selected"></span>
                                <?php endif;?>
                                <span class="arrow <?php if(isset($active) && ($active=='add_asset' || $active=='all_assets'|| $active=='asset_type')) echo 'open';?>"></span>
                            </a>
                            <ul class="sub-menu">                               
                                <li <?php if(isset($active) && $active=='add_asset') echo "class='active'";?>>
                                    <a href="<?php echo base_url();?>dashboard/add_asset">
                                        <i class="fa fa-plus-square"></i>
                                        Add Asset</a>
                                </li>
                                <li <?php if(isset($active) && $active=='all_assets') echo "class='active'";?>>
                                    <a href="<?php echo base_url();?>dashboard/all_assets">
                                        <i class="fa fa-file-archive-o"></i>
                                        All Assets</a>
                                </li>
                                <li <?php if(isset($active) && $active=='asset_type') echo "class='active'";?>>
                                    <a href="<?php echo base_url();?>dashboard/asset_type">
                                        <i class="fa fa-file-archive-o"></i>
                                        Asset Type</a>
                                </li>
                            </ul>
                    ...
                    <?php if($this->session->userdata('feedback') =='1'):  ?>
                        <li <?php if(isset($heading) && $heading=='Feedback'):?> class="start active open" <?php endif;?>>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li <?php if(isset($active) && $active=='add_feedback') echo "class='active'";?>>
                                    <a href="<?php echo base_url();?>dashboard/add_feedback">
                                        <i class="fa fa-file-archive-o"></i>
                                        Add Feedback</a>
                                </li>
                                <li <?php if(isset($active) && $active=='all_feedback') echo "class='active'";?>>
                    ...
                    <?php if($this->session->userdata('user_type_slug') =='G'):  ?>
                        <li <?php if(isset($heading) && $heading=='Feedback'):?> class="start active open" <?php endif;?>>
                            <a href="javascript:;">
                                <i class="fa fa-newspaper-o"></i>
                                <span class="title">Housekeeeping</span>
                                <?php if(isset($active) && ($active=='add_feedback' || $active=='all_feedback')):?>
                                    <span class="selected"></span>
                                <?php endif;?>
                                <span class="arrow <?php if(isset($active) && ($active=='add_feedback' || $active=='all_feedback')) echo 'open';?>"></span>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li <?php if(isset($active) && $active=='add_feedback') echo "class='active'";?>>
                                    <a href="<?php echo base_url();?>dashboard/add_housekeeping">
                                        <i class="fa fa-file-archive-o"></i>
                                        Add Housekeeping</a>
                                </li>
                                <li <?php if(isset($active) && $active=='all_feedback') echo "class='active'";?>>
                                    <a href="<?php echo base_url();?>dashboard/all_housekeepings">
                                        <i class="fa fa-file-archive-o"></i>
                                        All Housekeepings</a>
                                </li>
                            </ul>
                    ...
                    <?php if($this->session->userdata('feedback') =='1'):  ?>
                        <li <?php if(isset($heading) && $heading=='Feedback'):?> class="start active open" <?php endif;?>>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li <?php if(isset($active) && $active=='add_feedback') echo "class='active'";?>>
                                    <a href="<?php echo base_url();?>dashboard/housekeeping">
                                        <i class="fa fa-file-archive-o"></i>
                                        Housekeeping</a>
                                </li>
